...
class DRLoss(nn.Module):
    ...
    def forward(self, logits, targets, positive_indices, negative_indices):
        pos_ind = positive_indices
...
class DRLossFinal(nn.Module):
    def __init__(self):
        super(DRLossFinal, self).__init__()
        self.dr_loss = DRLoss()
    ...
    def forward(self, classifications, regressions, anchors, annotations):
        ...
        for j in range(batch_size):
            ...
            # DR LOSS
            cls_loss = self.dr_loss(classification, targets, positive_indices, negative_indices)
